package com.sapo.salemanagement.repositories.CustomerRepository;
...
public interface FeedbackRepository extends JpaRepository<Feedback, Integer> {
    ...
    @Query(value = "SELECT * FROM feedback f WHERE f.customer_id = :id ORDER BY f.id DESC"
            , nativeQuery = true)
    List<Feedback> findAllFeedbackByCustomer(@Param("id") int id);
