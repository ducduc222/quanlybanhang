package com.sapo.salemanagement.services.CustomerServices;
...
import com.sapo.salemanagement.repositories.CustomerRepository.FeedbackRepository;
...
public class FeedbackService {
    ...
    public List<Feedback> getFeedbackList(int id) {
        List<Feedback> feedbackList = feedbackRepository.findAllFeedbackByCustomer(id);
